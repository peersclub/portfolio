  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "border border-[var(--glass-border)] bg-[var(--bg-tertiary)] p-6 shadow-lg duration-200",
    ...
    >
      {children}
      <DialogClose className="absolute right-4 top-4 text-[var(--text-primary)] opacity-70 hover:opacity-100 transition-opacity">
        <X size={16} />
