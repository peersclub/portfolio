...
const menuPanelBase = [
  "z-50 min-w-[8rem] overflow-hidden rounded-sm border border-[var(--glass-border)]",
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(menuPanelBase, "shadow-lg", className)}
    {...props}
  />
));
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(menuPanelBase, "shadow-md", className)}
      {...props}
    />
  </DropdownMenuPrimitive.Portal>
));
