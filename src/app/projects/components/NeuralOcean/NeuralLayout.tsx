...
export default function NeuralLayout({ project }: NeuralLayoutProps) {
    ...
    return (
        <div className="neural-fresh-page bg-[#020c1b] h-screen overflow-y-scroll snap-y snap-mandatory text-slate-300 font-sans selection:bg-cyan-500/30" style={{ '--accent': '#00f3ff' } as React.CSSProperties}>
            <style jsx global>{`
                /* Override global cursor color for this page */
                :root, [data-theme='light'], [data-theme='dark'] {
                    --accent: #00f3ff !important;
                }
                /* FORCE DARK MODE VARIABLES FOR THIS PAGE */
                .neural-fresh-page {
                    --bg-primary: #020c1b;
                    --text-primary: #ffffff;
                ...
                /* Ensure paragraphs perform correctly */
                .neural-fresh-page p {
                    color: var(--text-secondary) !important;
                }
                /* Hide scrollbar for immersive feel */
                .neural-fresh-page::-webkit-scrollbar {
                    display: none;
                }
                .neural-fresh-page {
                    scrollbar-width: none;
                }
                /* Force body overflow hidden to let this container handle scroll */
                body {
            ...
            {/* Footer / Connect */}
            <div className="py-24 flex items-center justify-center bg-[#020c1b] border-t border-cyan-900/30">
